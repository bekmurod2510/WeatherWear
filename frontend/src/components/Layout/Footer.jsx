    ...
    <footer className="footer bg-base-200 text-base-content p-10">
      <div>
        ...
        <p className="max-w-xs">
          Smart clothing recommendations based on real-time weather data from around the world.
        </p>
      ...
      <div>
        ...
        <Link to="/history" className="link link-hover">History</Link>
      ...
      <div className="footer-center p-4 bg-base-300 text-base-content col-span-1 md:col-span-4 mt-8">
        <div>
          <p>Copyright © {currentYear} - All rights reserved by WeatherWear</p>
          <p className="text-sm mt-2">
            Weather data provided by <a href="https://openweathermap.org" target="_blank" rel="noopener noreferrer" className="link link-primary">OpenWeather</a>
          </p>
        </div>
      </div>
    </footer>
